<template>
    <div class="query-box">
        <el-input v-model="queryParams.full_name" placeholder="姓名" style="width: 120px" clearable></el-input>
...
<script setup>
import { getShuangyiStats } from '@/api';
import { ref } from 'vue';
...
const handleSearch = async () => {
    ...
    const resp = await getShuangyiStats(queryParams.value)
