<template>
    <div class="query-box">
        <SubjectSelect v-model:subject="queryParams.subjet" belong_to="体能" style="width: 240px;"></SubjectSelect>
...
import { getStaminaStatsByDate } from '@/api';
...
const handleSearch = async () => {
    ...
    const resp = await getStaminaStatsByDate(queryParams.value)
