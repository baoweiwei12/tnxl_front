<template>
    <div class="query-box">
        <SubjectSelect v-model:subject="queryParams.subjet" belong_to="双一" style="width: 240px;"></SubjectSelect>
...
import { getShuangyiStatsByDate } from '@/api';
...
const handleSearch = async () => {
    ...
    const resp = await getShuangyiStatsByDate(queryParams.value)
